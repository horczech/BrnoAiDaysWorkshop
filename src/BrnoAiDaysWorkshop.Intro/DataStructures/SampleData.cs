namespace BrnoAiDaysWorkshop.Intro.DataStructures
{
    ...
    {
        internal static readonly InputData Num1 = new InputData()
        {
        ...
        internal static readonly InputData Num7 = new InputData()
        {
        ...
        internal static readonly InputData Num9 = new InputData()
        {
